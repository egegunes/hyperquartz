...
// @ts-ignore
import hypertextParallaxScript from "./scripts/hypertextParallax.inline"
...
Body.afterDOMLoaded = [clipboardScript, lazyLoadScript, audioPlayerScript, hypertextParallaxScript]
